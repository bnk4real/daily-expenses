...
$sql = "SELECT * FROM daily_expenses
        ...
        AND daily_expenses.trans_type_id = '001'
...
<body class="bg-gray-200">
    ...
    <div class="container mx-auto px-4">
        <h2 class="text-2xl mt-5 mb-4">Income Transactions</h2>
        <table id="transactionTable" class="min-w-full bg-white border border-gray-300">
            <thead>
                <tr>
                    <th class="py-2 px-4 bg-gray-100 font-medium">Date</th>
                    <th class="py-2 px-4 bg-gray-100 font-medium">Transaction Name</th>
                    <th class="py-2 px-4 bg-gray-100 font-medium">Amount</th>
                    <th class="py-2 px-4 bg-gray-100 font-medium">Account Name</th>
                </tr>
            </thead>
            <tbody>
